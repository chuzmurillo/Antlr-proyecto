            ...
            var parseRegOrNumber = function (input, typeReg, typeNumber) {
                ...
                if (register !== undefined) {
                    ...
                    if (label !== undefined) {
                        ...
                        else if (value < 0 || value > 323)
                            throw typeNumber + " must have a value between 0-323";
                        ...
                        if (match[2] !== undefined) {
                            ...
                            switch (instr) {
								...
								//extra de print_string	
								 case 'PRS':
                                   ...
                                   if (p1.type === "number")
                                        ...
                                        throw "PRS does not support this operands";
								...
								case 'PRN':
                                    ...
                                    if (p1.type === "register")
                                        opCode = opcodes.PRINT_NUMBER;
                                    else
                                        throw "PRN does not support this operand";
